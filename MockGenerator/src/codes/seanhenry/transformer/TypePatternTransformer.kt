...
class TypePatternTransformer : SwiftVisitor() {
  ...
  override fun visitAsExpression(element: SwiftAsExpression) {
    transformedType = element.typeElement?.let { TypeTransformer.transform(it) }
  }

  override fun visitIsExpression(element: SwiftIsExpression) {
