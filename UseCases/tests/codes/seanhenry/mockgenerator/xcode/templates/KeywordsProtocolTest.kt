...
class KeywordsProtocolTest: MockGeneratorTestTemplate {
  ...
  override fun build(generator: XcodeMockGenerator) {
    ...
    generator.add(
        ProtocolMethod("run", null, "for: Int", "func run(for: Int)"),
        ProtocolMethod("`for`", null, "in: String", "func `for`(in: String)"),
        ProtocolMethod("statements", null, "break: Int, case: Int, continue: Int, default: Int, defer: Int, do: Int, else: Int, fallthrough: Int, for: Int, guard: Int, if: Int, in: Int, repeat: Int, return: Int, switch: Int, where: Int, while: Int", "func statements(break: Int, case: Int, continue: Int, default: Int, defer: Int, do: Int, else: Int, fallthrough: Int, for: Int, guard: Int, if: Int, in: Int, repeat: Int, return: Int, switch: Int, where: Int, while: Int)"),
        ProtocolMethod("declarations", null, "associatedtype: Int, class: Int, deinit: Int, enum: Int, extension: Int, fileprivate: Int, func: Int, import: Int, init: Int, `inout`: Int, internal: Int, `let`: Int, open: Int, operator: Int, private: Int, protocol: Int, public: Int, static: Int, struct: Int, subscript: Int, typealias: Int, `var`: Int", "func declarations(associatedtype: Int, class: Int, deinit: Int, enum: Int, extension: Int, fileprivate: Int, func: Int, import: Int, init: Int, `inout`: Int, internal: Int, `let`: Int, open: Int, operator: Int, private: Int, protocol: Int, public: Int, static: Int, struct: Int, subscript: Int, typealias: Int, `var`: Int)"),
        ProtocolMethod("expressionsAndTypes", null, "as: Int, Any: Int, catch: Int, false: Int, is: Int, nil: Int, rethrows: Int, super: Int, Self: Int, throw: Int, throws: Int, true: Int, try: Int", "func expressionsAndTypes(as: Int, Any: Int, catch: Int, false: Int, is: Int, nil: Int, rethrows: Int, super: Int, Self: Int, throw: Int, throws: Int, true: Int, try: Int)"),
        ProtocolMethod("reserved", null, "associativity: Int, convenience: Int, dynamic: Int, didSet: Int, final: Int, get: Int, infix: Int, indirect: Int, lazy: Int, left: Int, mutating: Int, none: Int, nonmutating: Int, optional: Int, override: Int, postfix: Int, precedence: Int, prefix: Int, Protocol: Int, required: Int, right: Int, set: Int, Type: Int, unowned: Int, weak: Int, willSet: Int", "func reserved(associativity: Int, convenience: Int, dynamic: Int, didSet: Int, final: Int, get: Int, infix: Int, indirect: Int, lazy: Int, left: Int, mutating: Int, none: Int, nonmutating: Int, optional: Int, override: Int, postfix: Int, precedence: Int, prefix: Int, Protocol: Int, required: Int, right: Int, set: Int, Type: Int, unowned: Int, weak: Int, willSet: Int)")
    )
  }
