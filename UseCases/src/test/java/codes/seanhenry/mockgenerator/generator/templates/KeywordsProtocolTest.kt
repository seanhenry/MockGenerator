...
class KeywordsProtocolTest: MockGeneratorTestTemplate {
  ...
  override fun build(generator: MockTransformer) {
    ...
    generator.add(
        Method("run", null, "for: Int", "func run(for: Int)"),
        Method("`for`", null, "in: String", "func `for`(in: String)"),
